  ...
  try {
    ...
    do {
      const url = `https://api.airtable.com/v0/${AIRTABLE_BASE}/${TABLE}?` +
        ...
        '&fields[]=Status&fields[]=Source&fields[]=Email&fields[]=Owner&fields[]=Affiliate+Interest&fields[]=Outreach+Tier&fields[]=DM+Draft&fields[]=Email+Draft&fields[]=Last+Contacted+At&fields[]=Category&fields[]=Archived&fields[]=Date+Added&fields[]=Contacted+By&fields[]=Nurturing+Started' +
